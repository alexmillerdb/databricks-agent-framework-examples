...
# MAGIC 
# MAGIC **Prerequisites**
# MAGIC * Databricks Runtime 15.4+ (or DBR 15.x) with Python 3.10+ or Serverless CPU version 3
...
# MAGIC * A Databricks Model endpoint (or pay-per-token LLM) accessible via `dspy.LM`. 
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## (section removed – ChatAgent is now loaded from external file)

# COMMAND ----------
# Quick smoke-test of the imported agent
...
agents.deploy(UC_MODEL_NAME, uc_registered_model_info.version, tags={"endpointSource": "dspy-rag-agent-v1"})
# COMMAND ----------
# MAGIC %md
# MAGIC ### Next steps
